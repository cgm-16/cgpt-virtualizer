...
export function resolveSelectors(
  ...
  const scrollContainer = document.querySelector<HTMLElement>(registry.scrollContainer)
  const transcriptRoot = document.querySelector<HTMLElement>(registry.transcriptRoot)
