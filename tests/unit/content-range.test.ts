...
describe('findRangeByScrollPosition', () => {
  ...
  it('uses binary search to resolve the initial overscanned range near the top', () => {
    expect(findRangeByScrollPosition([100, 200, 300, 400, 500], 0, 100, 100, 100)).toEqual({
      start: 0,
      end: 1,
    })
  })
  ...
  it('clamps the overscanned range near the end of the transcript', () => {
    expect(findRangeByScrollPosition([100, 200, 300, 400, 500], 400, 100, 100, 100)).toEqual({
      start: 3,
      end: 4,
    })
  })
